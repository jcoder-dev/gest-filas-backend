    ...
    <div class="col-md-10 col-sm-10 text-center m-auto">
        <div class="col-10 text-center m-auto">
            <ul class="list-group">
                ...
                <li class="list-group-item list-group-item-action rounded mt-3 opcao">Solicitar com Notas
                </li>
                ...
                <li class="list-group-item list-group-item-action rounded mt-3 opcao">Inscrição para
                     Preparatório
                </li>
        ...
        <div class="btn-group shadow-sm col-sm-12 p-2 bg-body rounded-circle" id="btn-custom">
            <button type="button" id="botaoRequisitarSenha"
                class="btn btn-outline-primary rounded-circle">Requisitar Senha <br> <i
